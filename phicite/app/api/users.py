...
async def get_user_by_username(username: str = Path(..., min_length=1)) -> UserSchema:
...
async def get_user_by_email(email: str = Path(..., min_length=1)) -> UserSchema:
...
async def get_user_by_id(id: int = Path(..., gt=0)) -> UserSchema:
